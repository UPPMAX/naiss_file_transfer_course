...
- log in to their center
    - Remote desktop environment using website (for example, as shown in this UPPMAX page](https://docs.uppmax.uu.se/getting_started/login_pelle_remote_desktop_website/))
