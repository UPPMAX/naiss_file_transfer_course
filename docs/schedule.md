...
9:50  |.      |Break
10:05 |B      |[Login with terminal](sessions/login_terminal/README.md) and [file transfer using scp](sessions/scp/README.md)
11:00 |.      |Break
11:15 |R      |(optional) [file transfer using rsync](sessions/rsync/README.md), (optional) [file transfer using sftp](sessions/sftp/README.md)
